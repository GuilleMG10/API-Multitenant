...
let TenantDataSourceService = TenantDataSourceService_1 = class TenantDataSourceService {
    constructor(dataSource) {
        ...
        this.logger = new common_1.Logger(TenantDataSourceService_1.name);
    }
    ...
    async setTenantSchema(queryRunner, schemaName) {
        await queryRunner.query(`SET search_path TO "${schemaName}", public`);
    }
    getQueryRunnerWithSchema(_schemaName) {
...
//# sourceMappingURL=tenant-data-source.service.js.map