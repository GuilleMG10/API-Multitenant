...
let User = class User {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, email: { required: true, type: () => String }, password: { required: true, type: () => String }, firstName: { required: true, type: () => String }, lastName: { required: true, type: () => String }, role: { required: true, enum: require("../enums/user-role.enum").UserRole }, tenantId: { required: true, type: () => String, nullable: true }, tenant: { required: true, type: () => require("../../tenants/entities/tenant.entity").Tenant }, isActive: { required: true, type: () => Boolean }, refreshToken: { required: true, type: () => String, nullable: true }, createdAt: { required: true, type: () => Date }, updatedAt: { required: true, type: () => Date } };
    }
};
exports.User = User;
__decorate([
